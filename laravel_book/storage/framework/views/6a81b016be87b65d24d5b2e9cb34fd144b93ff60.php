...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('codefox/libs/bootstrap-select/bootstrap-select.min.css')); ?>" rel="stylesheet" type="text/css" />

        <!-- c3 plugin css -->
        <!-- <link rel="stylesheet" type="text/css" href="assets/libs/c3/c3.min.css"> -->

        <!-- App css -->
        <link href="<?php echo e(asset('codefox/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" id="bootstrap-stylesheet" />
        <link href="<?php echo e(asset('codefox/css/icons.min.css')); ?>" rel="stylesheet" type="text/css" />
        <link href="<?php echo e(asset('codefox/css/app.min.css')); ?>" rel="stylesheet" type="text/css"  id="app-stylesheet" />
                ...
                <div class="navbar-custom">
                    ...
                    <h3 class="text-white">Selamat Datang di Website Book</h3>
                        <ul class="list-unstyled topnav-menu float-right mb-0">
                            ...
                            <li >                           
                                <a href="#" data-toggle="modal" class="nav-link right-bar-toggle waves-effect text-white waves-light"><?php echo e(Session::get('user')->u_name); ?></a>
                            </li>  
                            <li >                           
                            ...
                            <li class="dropdown notification-list">
                                <a href="<?php echo e(route('logout')); ?>" class="nav-link right-bar-toggle waves-effect waves-light text-white">
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="accordion" id="accordion-test">
                                    <div class="card mb-2">
                                        ...
                                        <div class="card-header bg-primary" style="background: darkcyan!important;" data-toggle="collapse" data-target="#collapseOneOne" aria-expanded="false" >
                                            <h4 class="card-title font-14 mb-0">
                                                <a href="#" class="text-white collapsed" >
                                                    Link Refrensi
                                                </a>
                                        ...
                                        <div class="card-header bg-primary" style="background:cadetblue !important;" data-toggle="collapse" data-target="#collapseOneTwo" aria-expanded="false" >
                                            <h4 class="card-title font-14 mb-0">
                                                <a href="#" class="text-white collapsed" >
                                                    Borang
                                                </a>
                                        ...
                                        <div class="card-header bg-primary" style="background: palegoldenrod!important;" data-toggle="collapse" data-target="#collapseOneFour" aria-expanded="false" >
                                            <h4 class="card-title font-14 mb-0">
                                                <a href="#" class="text-white collapsed" >
                                                    Play Card
                                                </a>
                                        ...
                                        <div class="card-header bg-primary" style="background:peachpuff !important;" data-toggle="collapse" data-target="#collapseOneFive" aria-expanded="false" >
                                            <h4 class="card-title font-14 mb-0">
                                                <a href="#" class="text-white collapsed" >
                                                    Video
                                                </a>
    ...
    <script src="<?php echo e(asset('assetsadmin/js/jquery-2.1.1.js')); ?>"></script>
<script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
    <script>
        ...
        function cekAkun(){
            axios.get('<?php echo e(route('cekakun')); ?>', {
            })
        ...
        function register(){
            axios.post('<?php echo e(route('register')); ?>', {
            ...
            .catch(function (error) {
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                2021 &copy; Website Book by <a href="">Book</a>
                            </div>
                            <div class="col-md-6">
        ...
        <!-- Vendor js -->
        <script src="<?php echo e(asset('codefox/js/vendor.min.js')); ?>"></script>

        <!-- App js -->
        <script src="<?php echo e(asset('codefox/js/app.min.js')); ?>"></script>
        
    </body>
</html><?php /**PATH D:\WORK\WEB\logaine\book\laravel_book\resources\views/dashboard.blade.php ENDPATH**/ ?>